...
function createBasicProxy(options = null) {
  ...
  const proxyOptions = {};
  const privateStore =
    typeof options.store == "object" && options.store !== null
      ? options.store
      : {};
  ...
  if (!options.hasOwnProperty("read")) {
    ...
    if (!readOptions.includes(options.read))
  ...
  if (options.hasOwnProperty("execute")) {
    proxyOptions.apply = (target, thisArg, args) => {
      const output = options.execute.apply(thisArg, [
        dataSources,
        target,
        args,
      ]);
  ...
  if (!options.hasOwnProperty("write")) {
    ...
    if (!writeOptions.includes(options.write))
  ...
  if (typeof options.get == "function") {
    if (read !== "allow")
      throw new Error(
        "Reading is not allowed but a get function was also supplied"
      );
  ...
  if (typeof options.set == "function") {
    if (write !== "allow")
      throw new Error(
        "Writing is not allowed but a set function was also supplied"
      );
  ...
  if (typeof options.delete == "function") {
    if (write !== "allow")
      throw new Error(
        "Writing is not allowed but a delete function was also supplied"
      );
  ...
  if (typeof options.getKeys == "function") {
    proxyOptions.enumerate = proxyOptions.ownKeys = () =>
      options.getKeys(dataSources);
  }
  ...
  const targetObject =
    originalObject !== null
      ? originalObject
      : options.hasOwnProperty("execute")
      ? () => {}
      : {};
