...
interface BasicProxyOptions {
  object?: AnyObject | Function,
  execute?: Function,
  get?: (originalObject: AnyObject, store: AnyObject, target: AnyObject, prop: string) => any,
  set?: (originalObject: AnyObject, store: AnyObject, target: AnyObject, prop: string) => boolean,
  has?: (originalObject: AnyObject, store: AnyObject, target: AnyObject, prop: string) => boolean,
  
  read?: boolean | "allow" | "error" | "undefined",
  write?: boolean | "allow" | "error" | "silent",
  store?: AnyObject,
  delete?: Function,
  getKeys?: Function,
  construct?: Function
